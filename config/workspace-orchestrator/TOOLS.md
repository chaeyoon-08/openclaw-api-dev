...
orchestrator는 exec 도구로 gog 명령어를 직접 실행한다.
skills/gmail/SKILL.md, skills/calendar/SKILL.md, skills/drive/SKILL.md 참조.
...
2. 사용자 확인 후 exec 도구로 Drive에서 MEMORY.md 내용 가져오기:
   ```bash
   # DRIVE_MEMORY_FOLDER(기본값: openclaw-memory) 폴더에서 MEMORY.md 검색
   gog drive search "name = 'MEMORY.md'"
